export const Travels = () => {
    ...
    element.innerHTML = `
        ...
        <br/>tady bude appendovana komponenta Seznam cest a bude mozne se prokliknout do konkretni cesty (komponenta Cesta)
        <br/><br/>databaze - bude obsahovat seznam cest, ale zaroven i obrazky a texty jednotlivych cest ktere se z ni budou nacitat?</p>
    `
